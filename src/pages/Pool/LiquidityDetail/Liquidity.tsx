...
const Liquidity: React.FC = () => {
  ...
  return (
    <div className="p-16px flex bg-orange-light-hover flex-col items-start rounded-16px text-black-normal w-full">
      ...
      <span className="inline-block text-32px h-40px leading-40px mb-24px w-full overflow-hidden text-ellipsis whitespace-nowrap">{!token0Price || !token1Price ? <Spin /> : `$${liquidity}`}</span>
