...
import { resetToken } from './AddLiquidity/SelectPair';
        ...
        <div className="flex justify-start items-end pl-16px mb-16px lt-mobile:pl-0">
          <div className="flex-1 flex gap-20px items-end lt-mobile:flex-col lt-mobile:items-start">
            <div className="flex items-center lt-mobile:w-full">
              ...
              <div className="no-underline shrink-0 hidden lt-mobile:block">
                <Button
                  color="gradient"
                  className="px-24px h-40px text-14px rounded-100px"
                  id="earn-add-new-position"
                  onClick={() => {
                    resetToken();
                    setCurrentFee(3000);
          ...
          <div className="no-underline shrink-0 lt-mobile:hidden">
            <Button
              color="gradient"
              className="px-24px h-40px text-14px rounded-100px"
              id="earn-add-new-position"
