...
const TokenPair: React.FC<Props> = ({ position, leftToken, rightToken, inverted = false, showFee = true, className, ...props }) => {
  const { fee } = position;
  ...
  return (
    <div className={cx('flex items-center text-14px', className)} {...props}>
      ...
      <span className="mx-4px text-black-normal font-bold">
